...
The final public source package was release-checked with **272 tests passed / 22 skipped**, the release verifier passed, and the Windows release contract passed. The public experimental seed area contains documentation only.
...
The final V5.0.0 public package was validated with **272 passed / 22 skipped**, plus release-contract and Windows-release checks. The repository keeps the regression suite public so behavior changes can be reviewed instead of relying only on a packaged binary.
