...
> **Historical design reference.** 이 문서는 V4에서 도입된 Experimental Data / ML 설계 배경을 보존하기 위한 자료입니다. 현재 V6.0.0의 실제 동작 기준은 `README.md`, `README_KO.md`, `docs/V5_DECISION_SUPPORT_*.md`, 현재 source code 및 regression tests입니다.
