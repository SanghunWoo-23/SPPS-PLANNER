# SPPS Planner V6.0.0 Windows 빌드
...
의존성, V6 release contract, PyInstaller EXE, Inno Setup Installer를 순서대로
...
installer\output\SPPS_Planner_Setup_V6.0.0.exe
```
...
V6.0.0 내부 version, EXE version resource, Installer metadata, 삭제된 legacy
...
3. 빈 Work Item startup, V6.0.0 title/icon 확인
...
실행합니다. 이 검사는 V6.0.0 모듈, Fmoc 보호 아미노산, Batch 계산,
