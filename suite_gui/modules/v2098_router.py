"""Compatibility shim for V2.1.9 Project Manager modularization."""
...
def install_v2098_router(SPPSGui, ns: dict | None = None) -> None:
    """Compatibility installer; active GUI uses ProjectManagerController directly."""
    try: setattr(SPPSGui, '_v2098_router_installed', True)
